...
- Удаление черновика синхронизируется между Windows, Android и iPhone; завершённые операции по-прежнему не удаляются.
- Неизвестный штрихкод можно сразу назначить товару из списка либо найти товар вручную без назначения кода.
...
Текущая release candidate: `1.0.8+108`.
