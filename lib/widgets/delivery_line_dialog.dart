              ...
              child: SingleChildScrollView(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  DropdownButtonFormField<int>(
                    ...
                    isExpanded: true,
                    decoration: InputDecoration(labelText: 'Позиция', helperText: productLocked ? 'Товар зафиксирован выбранным или отсканированным кодом.' : null),
                  ...
                  if (initial?.sourceText != null) ...[
                    ...
                    Align(alignment: Alignment.centerLeft, child: Text('OCR: ${initial!.sourceText}', maxLines: 2, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodySmall)),
                  ],
                  if (scanWorkflow) ...[
                    const SizedBox(height: 10),
